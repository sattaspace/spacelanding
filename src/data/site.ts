...
export const ecosystem = {
  ...
  brands: [
    ...
    },
    {
      ...
      color: "#08e6e6",
      hex: "#08e6e6",
      desc: "TokenOps is an independent developer utility supported in part by Google AdSense advertisements. Advertisements delivered by Google or third-party ad networks help maintain server infrastructure and live API rate synchronization. All trademarks and brand names belong to their respective owners.A collection of useful tools and resources for developers and professionals. Providing efficient solutions for common tasks and challenges within the SattaSpace Ecosystem. All are Tools, Resources, Efficiency, and Designed for Developers and Professionals.",
      tags: [
        "Tools",
        "TokenOps",
        "Resources",
