...
export const philosophy = {
  ...
  items: [
    ...
    {
      title: 'Space — The <span class="text-gradient-cyan">Infinite Canvas</span>',
...
export const brand = {
  ...
  subheading: 'The DNA of every SattaSpace communication — colors, type, and form.',
  colors: [
  ...
  colorRatio: [
    { name: 'Cosmic Navy', hex: '#0A1F44', percent: 60, textColor: 'text-white/60' },
    { name: 'Quantum Cyan', hex: '#00B4E6', percent: 25, textColor: 'text-deep-space' },
    { name: 'Warm Entity', hex: '#FF6B35', percent: 10, textColor: 'text-white' },
    { name: 'Nebula Gray', hex: '#6C7A89', percent: 5, textColor: 'text-white/60' },
  ],
  typography: {
    display: {
      name: 'Montserrat',
    ...
    body: {
      ...
      weights: '300–800',
      sample: 'Where entities find their space to grow, evolve, and create lasting impact.',
    },
    brand: {
      name: 'Deadman',
...
export const footer = {
  ...
  subheading: "The ecosystem grows with every new entity. Let's create space for what's next.",
